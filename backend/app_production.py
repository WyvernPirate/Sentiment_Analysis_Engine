"""
Main Production Flask Application
...
def create_app(config_class=Config):
    ...
    def index():
        return jsonify({
            ...
            "documentation": {
                "simple_testing": "Use simple_app.py for development and testing",
                "production": "This is the production API with full features"
            }
        })
...
if __name__ == '__main__':
    print("🚀 Starting Botswana Political Sentiment Analysis Platform (Production)")
    print("=" * 70)
    print("📍 API Endpoints:")
    ...
    print("💡 For simple testing, use: python simple_app.py")
    print("=" * 70)
